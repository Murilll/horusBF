...
const Autocomplete = React.forwardRef(function Autocomplete(
  props: UseAutocompleteProps<(typeof collaborators)[number], false, false, false>,
      ...
      {anchorEl ? (
        ...
        >
          <StyledListbox {...getListboxProps()}>
            {(groupedOptions as typeof collaborators).map((option, index) => {
...
export default function AutocompleteIntroduction() {
  return <Autocomplete options={collaborators} />;
}
